...
pub const Opcode = enum(u8) { Return = 0, PushConstant, Negate, Add, Subtract, Multiply, Divide, Print, Pop, Plus, Equal, Not, JumpIfFalse, JumpIfTrue, PushTrue, PushFalse, Greater, Less, PushNull, DefineGlobal, GetGlobal, SetGlobal, GetLocal, SetLocal, JumpIfFalsePop, Jump, Loop, Call, _ };
...
pub const Instruction = union(enum) {
    ...
    pub fn disassemble(self: *const Self, writer: anytype, chunk: *const Chunk, offset: usize) !void {
        ...
        switch (self.*) {
            ...
            .Call => {
                try self.Call.disassemble(writer, chunk, "Call", offset);
            },
        }
    }
};
